...
2. **Docker-контейнеризация**:
   ...
   - Docker Stack для развертывания в Swarm

3. **Скрипты развертывания**:
   - `deploy.sh` - для развертывания на одиночном сервере
   - `swarm_deploy.sh` - для развертывания в Docker Swarm

Подробные схемы архитектуры приложения доступны в файле [ARCHITECTURE.md](ARCHITECTURE.md), включая:
- Общую архитектуру приложения
- Варианты развертывания
- Процесс мониторинга и уведомлений
- Архитектуру Docker Swarm
